    ...
    <footer className="relative bg-navy text-white/80">
      ...
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-8">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  aria-label={label}
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-white/5 border border-white/10 text-white/60 hover:bg-emerald hover:text-white hover:border-emerald transition-all duration-300"
                >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-semibold text-gold uppercase tracking-wider mb-5">Quick Links</h4>
          ...
          {/* Services */}
          <div>
            <h4 className="text-sm font-semibold text-gold uppercase tracking-wider mb-5">Our Services</h4>
            <ul className="space-y-3">
              {[
                "Umrah Packages",
                "Hajj Packages",
          ...
          {/* Contact */}
          <div>
            <h4 className="text-sm font-semibold text-gold uppercase tracking-wider mb-5">Contact Us</h4>
            <div className="space-y-4">
              <a
                href={`tel:${COMPANY.phone.replace(/\s/g, "")}`}
                className="flex items-start gap-3 group"
              >
                <Phone className="h-4 w-4 mt-0.5 text-emerald-light shrink-0" />
              ...
              <a href={`mailto:${COMPANY.email}`} className="flex items-start gap-3 group">
                <Mail className="h-4 w-4 mt-0.5 text-emerald-light shrink-0" />
                <span className="text-sm text-white/60 group-hover:text-white transition-colors break-all">
                  {COMPANY.email}
                </span>
              </a>
              <div className="flex items-start gap-3">
                <MapPin className="h-4 w-4 mt-0.5 text-emerald-light shrink-0" />
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <a href="/privacy-policy" className="text-xs text-white/40 hover:text-gold transition-colors">
              Privacy Policy
            </a>
            <a href="/terms" className="text-xs text-white/40 hover:text-gold transition-colors">
              Terms of Service
            </a>
          </div>
        </div>
